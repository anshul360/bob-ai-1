...
export default function Demoplay() {
    ...
    return <>
        <div className=" relative flex w-full lg:w-[50%] mt-1 font-semibold text-zinc-900 lg:text-2xl justify-center items-center rounded-sm group " >{/**"conic-gradient(cyan,blue,purple)" */}
            ...
            <div className=" flex absolute w-full h-full bg-gray-400 top-0 left-0 opacity-75 -arotate-[12deg] scale-[115%] z-[1] rounded-full"></div>
            <div className=" flex absolute w-full h-full bg-gray-500 top-0 left-0 opacity-75 -raotate-[8deg] scale-110 z-[2] rounded-full"></div>
            <div className=" flex absolute w-full h-full bg-gray-600 top-0 left-0 opacity-75 -arotate-[4deg] scale-105  z-[3] rounded-full"></div>
