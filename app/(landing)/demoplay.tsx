...
export default function Demoplay() {
    ...
    return <>
        <div className=" relative flex w-full lg:w-[50%] mt-1 font-semibold text-zinc-900 lg:text-2xl justify-center items-center rounded-sm overflow-hidden " >{/**"conic-gradient(cyan,blue,purple)" */}
            <img src="/lib/image/home/video.png" width="auto" height="auto" alt="Opening" className=" flex blur-sm w-full "/>
        ...
        {playvideo && <div className={` bg-opacity-60 bg-black flex absolute top-0 left-0 justify-center h-[100vh] w-full `} onClick={() => setplayvideo(false)}>
