...
export default function Hero({session}: any) {
    ...
    return <>
        ...
        {/* <section className="dark:bg-black bg-black flex flex-col overflow-hidden relative items-center justify-center  min-h-[90vh] ">
            ...
            <div className="relative flex max-w-[80rem] gap-10 lg:gap-[150px] w-full px-4 flex-col lg:flex-row mx-auto pb-5 lg:px-8 items-center justify-center mt-6 lg:mt-0 lg:pt-28">
                <div className=" ">
