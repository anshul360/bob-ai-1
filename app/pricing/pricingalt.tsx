    ...
    return <section className="mb-12 bg-black ">
        <div className="relative flex max-w-[80rem] w-full px-4 flex-col mx-auto gap-4  sm:px-6 lg:px-8 items-start justify-center mt-10 sm:mt-0">
            <div className="flex flex-col text-4xl sm:text-6xl items-center justify-center p-2 rounded-xl h-auto w-full " style={{fontWeight: ""}}>
                ...
                <p className="text-2xl lg:text-3xl text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 via-cyan-400 to-cyan-400 pb-3 text-center">Start your <span className="underline font-bold">7 days Free</span> trial now! <span className="underline font-semibold">(No CC required)</span></p><div className="text-lg lg:text-2xl flex gap-6 items-center justify-center text-center text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 via-cyan-400 to-cyan-400 ">    
                    Pay
                </div>
