                ...
                <div className=" px-4 py-8 mx-auto sm:px-6 sm:pt-8 lg:px-8 h-full flex flex-col items-center w-full ">
                    ...
                    <div className="sm:align-center flex flex-col w-full h-full gap-4 ">
                        <div className=" flex flex-col gap-2 w-full relative group">
                            <p className=" text-lg font-semibold ">Add Domain names</p>
                            <textarea rows={3} onChange={(e) => setbdomains(e.currentTarget.value)} value={bdomains} 
                            className=" flex w-full p-2 font-semibold text-slate-500 outline-none rounded-md " placeholder="Enter you domain names"/>
                            <p className=" text-base font-semibold ">
                                Add the domain names which you wish to embed the chatbot on.
                                You can add multiple domains using comma. Format &lt;your_domain&gt;.com
                            </p>
                        </div>
                        <div className=" flex flex-col gap-2 w-full">
                            ...
                            <p className=" text-base font-semibold ">
                                Private: Chatbot Will not be available for embedding in your Domains. 
                                Public: Chatbot Will be available for embedding in your Domains
                            </p>
                        </div>
                    </div>
                </div>
