...
export default function Baseconfig({botId, user}: any) {
    ...
    after:content-[''] checked:bg-[#00FFFF] checked:after:absolute checked:after:z-[2] checked:after:-mt-[3px] checked:after:ml-[1.0625rem] checked:after:h-5 checked:after:w-5 
    checked:after:rounded-full checked:after:border-none checked:after:bg-[#00FFFF] 
    ...
    checked:focus:border-primary checked:focus:bg-[#00FFFF] checked:focus:before:ml-[1.0625rem] checked:focus:before:scale-100 
