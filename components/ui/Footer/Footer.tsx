...
export default function Footer() {
  ...
  return (
    <footer className=" relative mx-auto px-6 bg-zinc-900">
      ...
      <div className="flex flex-col items-center justify-center py-12 space-y-4 md:flex-row bg-zinc-900">
        <div>
          <span className=" flex flex-col gap-2 items-center   ">
            {/* <Image src="/lib/image/indiaFl1.png" height={100} width={100} alt="A Product of India" className=" w-10 rounded-sm overflow-hidden " title="A Product of India" /> */}
