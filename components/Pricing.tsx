    ...
    <section className="dark:bg-black bg-white ">{/** className="dark:bg-black bg-zinc-200 "  */}
      <div className="relative max-w-6xl px-4 py-8 mx-auto sm:py-24 sm:px-6 lg:px-8">
        <div className="sm:flex sm:flex-col sm:align-center">
          ...
          <p className="max-w-2xl m-auto mt-5 text-xl dark:text-zinc-200 text-zinc-600 sm:text-center sm:text-2xl">
            Delight your customers with our core products.
          </p>
        ...
        <div className="mt-12 space-y-4 sm:mt-16 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-6 lg:max-w-4xl lg:mx-auto xl:max-w-none xl:mx-0 xl:grid-cols-3">
          {products.map((product) => {
            const price = product?.prices?.find(
              (price) => price.interval === billingInterval && price.currency === "inr"
            );
